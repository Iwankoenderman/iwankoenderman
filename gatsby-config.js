...
module.exports = {
  ...
  siteMetadata: {
    ...
    description: 'Creatieve ondernemer/ coach? Leer in 5 stappen hoe je jouw boodschap effectief verwoordt en klanten aantrekt via socials. Bereik financiële vrijheid. Klik nu!',
