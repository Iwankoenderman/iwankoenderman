...
const cspDirectives = [
  "default-src 'self' 'unsafe-inline' https://*.hotjar.com https://*.hotjar.io wss://*.hotjar.com https://js.stripe.com/v3 https://snap.licdn.com",
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com/ https://*.hotjar.com https://js.stripe.com/v3 https://snap.licdn.com, https://connect.facebook.net https://*.facebook.com",
  "font-src 'self' https://*.hotjar.com",
  "style-src 'self' 'unsafe-inline' https://*.hotjar.com",
  "img-src 'self' data: https://iwankoenderman/  https://*.google-analytics.com https://www.googletagmanager.com/ https://*.hotjar.com https://px.ads.linkedin.com https://www.facebook.com https://*.facebook.com",
  "frame-src 'self' https://www.youtube-nocookie.com https://youtube-nocookie.com https://*.hotjar.com https://js.stripe.com/ https://www.facebook.com;", 
  "connect-src 'self'  https://*.google-analytics.com/ https://*.analytics.google.com/ https://*.googletagmanager.com/ https://*.hotjar.com https://*.hotjar.io wss://*.hotjar.com https://px.ads.linkedin.com https://*.facebook.com",
  ...
  siteMetadata: {
    ...
    plugins: [   
      ...
      `gatsby-plugin-webpack-bundle-analyser-v2`,    
      {
        ...
        options:  { paths: ['/en/**', '!/en/', '!/en/thanksebook', '!/en/privacystatementandcookiepolicy/', '!/en/brandidentityvideoiwankoenderman/', '!/en/videoreviewenglish/', '!/en/termandconditions/', '!/en/faq/', '!/en/introductionvideoiwankoenderman', '!/en/linktreefromcoachiwankoenderman', '!/en/cancelpayment','!/en/scedulefirstzoomsession','/nl/**',                                   
      ] },
      ...
      options: {
        excludes: ['/privacystatementandcookiepolicy/', '/termandconditions/', '/thanksebook/', '/bedanktebook/', '/cancelpayment/', '/introductionvideo/', '/videoreviewenglish/', '/scedulefirstzoomsession/', '/brandidentityvideoiwankoenderman/',  '/linktreefromcoachiwankoenderman/', '/faq/',]
      }
      },
    {
