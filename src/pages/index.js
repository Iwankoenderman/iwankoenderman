    ...
    <Layout location={location }>      
         ...
         <div className='mainblock__hoofdrow'>   
                                          <div className='mainblock__pakket'>
                                           ...
                                           ButTxten="Schedule zoom call"/>  
                                                   <Pakketkolom 
                                                        headrownl    = "Boost Je Online Zichtbaarheid Plan!"
                                                        pakketrow1nl = "✔ Verwoord in één krachtige zin hoe jouw passie het verschil maakt voor je klant en welk tastbaar resultaat dat oplevert."
                                                        pakketrow2nl = ""
                                                        pakketrow3nl = ""
                                                        ...
                                                        headrowen    = "Boost Your Online Visibility Plan!"
                                                        pakketrow1en = "✔ Convey in one powerful sentence how your passion makes a difference for your client and the tangible results it delivers."  
                                                        pakketrow2en = ""                                           
                                                        pakketrow3en = "" 
                                           ...
                                           ButTxten="Schedule zoom call"/>  
                                                        <Pakketkolom 
                                                        headrownl    = "Verbeter Je Online Zichtbaarheid Plan!"
                                                        pakketrow1nl = "✔ Verwoord in één krachtige zin hoe jouw passie het verschil maakt voor je klant en welk tastbaar resultaat dat oplevert. "
                                                        pakketrow2nl = "✔ + Krachtige social media strategie die impact maakt!" 
                                                        pakketrow3nl = ""
                                                        pakketrow4nl = "✔ 1 op 1 coaching,"
                                                        pakketrow5nl = "✔ 4 zoomsessies begeleiding." 
                                                        pakketrow6nl = "✔ Uitbreidbaar met extra zoomsessies indien meer diepgang gewenst is (meerprijs)"
                                                        pakketrow7nl = "€ 649,00 excl. BTW"
                                                        headrowen    = "Improve Your Online Visibility Plan!"
                                                        pakketrow1en = "✔ Convey in one powerful sentence how your passion makes a difference for your client and the tangible results it delivers."
                                                        pakketrow2en = "✔ + Powerful social media strategy that makes an impact!"
                                                        pakketrow3en = ""
                                                        pakketrow4en = "✔ 1 on 1 coaching,"
                                           ...
                                           ButTxten="Schedule zoom call"/>  
                                                   <Pakketkolom 
                                                        headrownl    = "Optimaliseer Je Online Zichtbaarheid plan!"
                                                        pakketrow1nl = "✔ Verwoord in één krachtige zin hoe jouw passie het verschil maakt voor je klant en welk tastbaar resultaat dat oplevert."
                                                        pakketrow2nl = "✔ + Krachtige social media strategie die impact maakt!" 
                                                        pakketrow3nl = "✔ ++ Toon het resultaat dat je levert met krachtige, authentieke content!" 
                                                        pakketrow4nl = "✔ 1 op 1 coaching,"
                                                        pakketrow5nl = "✔ 5 zoomsessies begeleiding," 
                                                        pakketrow6nl = "✔ Uitbreidbaar met extra zoomsessies indien meer diepgang gewenst is (meerprijs)."
                                                        pakketrow7nl = "€ 1149,00 excl. BTW"
                                                        headrowen    = "Optimize Your Online Visibility Plan!"
                                                        pakketrow1en = "✔ Convey in one powerful sentence how your passion makes a difference for your client and the tangible results it delivers."
                                                        pakketrow2en = "✔ + Powerful social media strategy that makes an impact!"
                                                        pakketrow3en = "✔ ++ Show the results you deliver with powerful, authentic content!"
                                                        pakketrow4en = "✔ 1 on 1 coaching,"
